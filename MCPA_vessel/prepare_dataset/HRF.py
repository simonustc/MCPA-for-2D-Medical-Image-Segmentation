...
if __name__ == "__main__":
    # ------------Path of the dataset -------------------------
    data_root_path = '/home/xl/work/cmx/2.17-glunet/HRF/all/'
    ...
    gt_train = "train/manual1/"
    fov_train = "train/mask/"
    # test
    img_test = "test/images/"
    gt_test = "test/manual1/"
    fov_test = "test/mask/"
    # ----------------------------------------------------------
    save_path = "/home/xl/work/cmx/2.17-glunet/2.17-3/prepare_dataset/data_path_list/HRF/"
