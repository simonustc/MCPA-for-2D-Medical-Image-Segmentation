...
class Evaluate():
    def __init__(self, dataset=None,save_path=None):
        self.target = None
        self.output = None
    ...
    def confusion_matrix(self):
        ...
        FP, FN, TP, TN = numeric_score(y_pred, self.target)
        ...
        return confusion, accuracy, specificity, sensitivity, precision, f1
    ...
    def save_all_result(self, plot_curve=True, save_name=None):
        ...
        confusion, accuracy, specificity, sensitivity, precision, f1 = self.confusion_matrix()
