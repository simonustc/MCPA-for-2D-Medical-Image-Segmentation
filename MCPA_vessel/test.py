...
class Test():
    def __init__(self, args):
        ...
        # save path
        self.path_experiment = join(args.outf, args.name,args.save)
    ...
    def evaluate(self):
        ...
        eval = Evaluate(dataset=self.dataset,save_path=self.path_experiment)
...
if __name__ == '__main__':
    ...
    save_txt=join(args.outf, args.name,args.save)
    sys.stdout = Print_Logger(os.path.join(save_txt, 'test_log.txt'))
    ...
    checkpoint = torch.load(join(save_path))
    # checkpoint = torch.load('/home/xl/cmx/unet-vessel/11.16/11.15/experiments/11.18/lr0.0010-batch64-epoch70/1/best_model.pth')
