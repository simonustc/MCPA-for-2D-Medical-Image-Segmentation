...
parser.add_argument('--list_dir', type=str,
                    default='./lists/list_ACDC/', help='list dir')
parser.add_argument('--num_classes', type=int,
                    default=4, help='output channel of network')  # ACDC
parser.add_argument('--output_dir', type=str,
                    default='./',
                    help='output dir')
# recite test's output_dir
parser.add_argument('--max_iterations', type=int,
                    default=400000, help='maximum epoch number to train')
...
parser.add_argument('--cfg', type=str, default='./configs/ACDC.yaml', required=False, metavar="FILE",
    ...
    for k in range(200):
        ...
        dataset_config = {
            'Synapse': {
                ...
                'list_dir': '/home/xmj/4T/work/6.14van-net/6.23/Unet-code/lists/list_ACDC/,
                'num_classes': 9,
            },
        }
        ...
        trainer[dataset_name](args, k, config, net, args.output_dir)
        # print(k)
        # print('ds')
        # trainer_ACDC(args, k, config, net, args.output_dir)
        # print("trainer",trainer[dataset_name])
