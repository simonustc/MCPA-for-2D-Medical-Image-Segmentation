...
parser.add_argument('--model_path', type=str,default='./epoch_399.pth', help='model_path')
parser.add_argument('--volume_path', type=str,
                    default='/home/xmj/4T/work/project_TransUNet/data/Synapse/', help='root dir for validation volume data')  # for acdc volume_path=root_dir
