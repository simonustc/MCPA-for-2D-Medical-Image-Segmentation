...
parser.add_argument('--cfg', type=str, default='./configs/Synapse.yaml',required=False, metavar="FILE", help='path to config file', )
parser.add_argument('--root_path', type=str,
                    default='/home/xmj/4T/work/project_TransUNet/data/Synapse/', help='root dir for data')
...
if __name__ == "__main__":
    ...
    #args.batch_size = args.batch_size * (len(strGPUs))
